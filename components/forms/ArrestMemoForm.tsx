...
const ArrestMemoForm: React.FC<ArrestMemoFormProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent, complete = false) => {
    ...
    try {
      const memoData = {
        ...
        arresting_officer_signature: formData.arresting_officer_signature || null,
  ...
  return (
    <form onSubmit={(e) => handleSubmit(e, false)} className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) => handleChange('court_production_date', e.target.value)}
            required
          />
        </div>
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) => handleChange('court_production_time', e.target.value)}
            required
          />
        </div>
      </div>
      ...
      <div className="space-y-2">
        <Label htmlFor="vehicle_registration">Vehicle Registration (if applicable)</Label>
        <Input
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => handleChange('arresting_officer_name', e.target.value)}
              required
            />
          </div>
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => handleChange('arresting_officer_designation', e.target.value)}
              required
            />
          </div>
        </div>
