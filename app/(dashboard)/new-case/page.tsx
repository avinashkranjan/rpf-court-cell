...
const NewCase: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const { error: accusedError } = await supabase
        .from("accused")
        .insert(accusedRecords);
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleCaseChange("station_name", e.target.value)
                  }
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleCaseChange("platform_number", e.target.value)
                  }
                  placeholder="e.g., 10"
                />
              </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleCaseChange("incident_location", e.target.value)
                }
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleCaseChange("train_number", e.target.value)
                  }
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleCaseChange("train_name", e.target.value)
                  }
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleCaseChange("coach_number", e.target.value)
                  }
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleCaseChange("raid_start_time", e.target.value)
                  }
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleCaseChange("raid_end_time", e.target.value)
                  }
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleCaseChange("gd_entry_number", e.target.value)
                  }
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleCaseChange("court_name", e.target.value)
                  }
                  placeholder="e.g., Ld. RJM/Howrah"
                />
              </div>
              <div className="space-y-2">
                <Label htmlFor="court_production_date">
                  Court Production Date
                </Label>
                <Input
                  ...
                  onChange={(e) =>
                    handleCaseChange("court_production_date", e.target.value)
                  }
                />
              </div>
              <div className="space-y-2">
                <Label htmlFor="court_production_time">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleCaseChange("court_production_time", e.target.value)
                  }
                />
              </div>
            </div>
          ...
          <Card key={index}>
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Personal details of the accused person
                </CardDescription>
              </div>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleAccusedChange(index, "full_name", e.target.value)
                    }
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleAccusedChange(index, "father_name", e.target.value)
                    }
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    value={accused.age}
                    onChange={(e) =>
                      handleAccusedChange(index, "age", e.target.value)
                    }
                    placeholder="e.g., 25"
                    min="1"
                    max="120"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(v) =>
                      handleAccusedChange(index, "gender", v)
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleAccusedChange(index, "pincode", e.target.value)
                    }
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleAccusedChange(index, "address_line1", e.target.value)
                  }
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleAccusedChange(index, "village_town", e.target.value)
                    }
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleAccusedChange(index, "post_office", e.target.value)
                    }
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleAccusedChange(index, "district", e.target.value)
                    }
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    value={accused.state}
                    onValueChange={(v) =>
                      handleAccusedChange(index, "state", v)
                    }
                  >
                    <SelectTrigger>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleAccusedChange(index, "ticket_from", e.target.value)
                    }
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleAccusedChange(index, "ticket_to", e.target.value)
                    }
