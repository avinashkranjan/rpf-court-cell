    ...
    const fetchData = async () => {
      try {
        ...
        const { data: cases } = await supabase
          .from('cases')
          .select('id, case_number, status, section_of_law, station_name, created_at')
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Cases registered today</p>
            </CardContent>
          </Card>
        </div>
          ...
          <CardContent>
            {loading ? (
              ...
              <div className="text-center py-8">
                ...
                <p className="mt-2 text-muted-foreground">No cases registered yet</p>
                <Button asChild className="mt-4">
                  <Link to="/cases/new">Register First Case</Link>
                </Button>
              </div>
            ) : (
